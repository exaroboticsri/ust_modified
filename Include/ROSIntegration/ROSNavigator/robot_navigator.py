...
# from nav2_msgs.action import NavigateThroughPoses, NavigateToPose, FollowWaypoints, ComputePathToPose, ComputePathThroughPoses # foxy
from nav2_msgs.action import NavigateToPose, FollowWaypoints, ComputePathToPose  # eloquent
...
class BasicNavigator(Node):
    def __init__(self):
        ...
        self.nav_to_pose_client = ActionClient(self, NavigateToPose, '/NavigateToPose')
