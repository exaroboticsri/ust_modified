# -------------------------------------------------------------------------------------------------------------------- #
# File Name    : DockExaRobotCtrl.py
# Project Name : ExaRobotCtrl
# Author       : Raim.Delgado
# Organization : SeoulTech
# Description  :
# [Revision History]
# >> 2022.04.18 - First Commit
# -------------------------------------------------------------------------------------------------------------------- #
import os
import sys
...
class DockExaRobotCtrl(QtWidgets.QDockWidget):
    ...
    def __init__(self, parent=None):
        super(DockExaRobotCtrl, self).__init__(parent)
        ...
        self.setWindowTitle('ExaRobot Control Panel')
        self.initUi()
    ...
    def on_value_changed_right_wheel(self, val: int):
        ...
        vel_c, omega_c = CTMRExaRobot().calculate_center_vel((omega_r, omega_l))
    ...
    def on_value_changed_center_vel(self, val: int):
        ...
        omega_r, omega_l = CTMRExaRobot().calculate_joint_space_vel(val / 1000., omega_c)
    ...
    def on_value_changed_yaw_rate(self, val: int):
        ...
        omega_r, omega_l = CTMRExaRobot().calculate_joint_space_vel(vel_c, deg2rad(val))
